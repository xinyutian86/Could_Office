			...
			<div class="boxedWrap">
				...
				<div id="topOfPage" class="topTabsWrap">
					<div class="main">
						...
						<h1 class="pageTitle h1">我要听</h1></div>
				</div>
...
<table class="bordered">
	...
	%>
		...
		<tr id="table" class="admin"><td style="width: 50px;" class="bianhao"><%= m.get("from") %></td>
		<td class="author"><a href="<%=m.get("song")%>"><%= m.get("singer") %></a></td>
