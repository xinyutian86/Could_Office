	...
	<%
		...
		if(userinfo!=null){
			...
			if(pass.equals(password)){
				out.println("<div class=\"login-agileits-top\" align=\"center\"><br /><br /><br /><br /><br /><br /><img src=\"images/yes.png\"/><br /><br /><br /><br /><br /><br /></div> <h1 align=\"center\">登陆成功!</h1>");
				...
				out.println("<div class=\"login-agileits-top\" align=\"center\"><br /><br /><br /><br /><br /><br /><img src=\"images/no.png\"/><br /><br /><br /><br /><br /><br /></div> <h1 align=\"center\">登陆失败,密码错误!</h1>");
